...
function distance(_a, _b) {
	// [10/05/22] https://discord.com/channels/238332476743745536/949729873142878249/963682960626831370
	...
	if(a_w2 == 0 && a_h == 0 && b_w2 == 0 && a_h == 0) return Math.hypot(a_x - b_x, a_y - b_y)

	// Check overlap
	if ((a_x - a_w2) < (b_x + b_w2)
		&& (a_x + a_w2) > (b_x - b_w2)
		&& (a_y + a_h) > (b_y)
		&& (a_y) < (b_y + b_h)) return 0
